    ...
    SigninController = function ($http, $rootScope, $scope, principal, authority, authService) {

        var apiAuthUrl = Routing.generate('api_fos_user_security_check');
        ...
        $scope.signinButtonClick = function () {
          ...
          var body = {_username: $scope.username, _password: $scope.password};
