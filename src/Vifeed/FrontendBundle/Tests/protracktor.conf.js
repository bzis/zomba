...
exports.config = {
  ...
  suites: {
    full: 'e2e/*.js',
    advertiser: 'e2e/advertiser-app.spec.js',
    publisher: 'e2e/publisher-app.spec.js',
    index: 'e2e/index-app.spec.js'
  },
  ...
  baseUrl: 'http://vifeed.dev',
  // 'http://localhost:' + (process.env.HTTP_PORT || '8000'),
