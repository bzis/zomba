 ...
 */
class Version20131108162500 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE payment_order (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, created_at DATETIME NOT NULL, amount NUMERIC(2, 0) NOT NULL, paymentInstruction_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_A260A52AFD913E4D (paymentInstruction_id), INDEX IDX_A260A52AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("ALTER TABLE vifeed_user ADD balance NUMERIC(2, 0) NOT NULL");
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE vifeed_user DROP balance");
    }
}
