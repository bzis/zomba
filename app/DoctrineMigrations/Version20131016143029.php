 ...
 */
class Version20131016143029 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE platform ADD discr VARCHAR(255) NOT NULL, ADD vk_id INT DEFAULT NULL");
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE platform DROP discr, DROP vk_id");
    }
}
